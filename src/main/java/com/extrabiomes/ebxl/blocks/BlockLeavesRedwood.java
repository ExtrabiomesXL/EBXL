...
public class BlockLeavesRedwood extends BlockExtraLeaves{
    public BlockLeavesRedwood(){
        super();
        setUnlocalizedName( Extrabiomes.MODID + ".block." + "leaf_redwood" );
        setRegistryName( "leaf_redwood" );
    }
